...
/*   Updated: 2024/11/23 00:20:33 by upolat           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    if (bsp(a1, b1, c1, point1))
        ...
        std::cout << "Test 1: The point is NOT inside the triangle!" << std::endl;
    ...
    if (bsp(a2, b2, c2, point2))
        std::cout << "Test 2: The point is inside the triangle!" << std::endl;
    else
    ...
    if (bsp(a3, b3, c3, point3))
        std::cout << "Test 3: The point is inside the triangle!" << std::endl;
    else
    ...
    if (bsp(a4, b4, c4, point4))
        std::cout << "Test 4: The point is inside the triangle!" << std::endl;
    else
    ...
    if (bsp(a5, b5, c5, point5))
        std::cout << "Test 5: The point is inside the triangle!" << std::endl;
    else
    ...
    if (bsp(a6, b6, c6, point6))
        std::cout << "Test 6: The point is inside the triangle!" << std::endl;
    else
